working login->dashboard logic code take whats being implemented in this thats not in our code 
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-slate-900/95 backdrop-blur-xl border-b border-white/10 p-6 flex items-center justify-between z-10">
                <div className="flex items-center gap-3">
                  <span className={`text-xs px-3 py-1 r


ounded-full bg-gradient-to-r ${getCategoryColor(selectedNewsArticle.category)} font-medium`}>
              ...
              <div className="p-8">
                ...
                <div className="flex items-center gap-4 text-sm text-white/60 mb-6">
                  ...
                  <span>•</span>
                  <span className="flex items-center gap-1">
                    👁 {selectedNewsArticle.views} views
                  </span>
                </div>
